      ...
      html: `
        <div style="font-family: 'Apple SD Gothic Neo', 'Pretendard', sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 20px;">
          <div style="margin-bottom: 28px;">
            <img src="${process.env.NEXT_PUBLIC_BASE_URL || "https://ktc-support.vercel.app"}/logo.png" alt="KTC Support" width="36" height="36" style="border-radius: 6px;" />
          </div>
          ...
          <div style="text-align: center; margin-bottom: 32px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || "https://ktc-support.vercel.app"}/talents"
